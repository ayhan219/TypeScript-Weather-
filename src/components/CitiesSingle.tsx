...
const CitiesSingle = () => {
  return (
    <div>
        <div className='w-64 md:w-96 h-16 md:h-24 bg-[#202B3D] flex items-center rounded-lg justify-between cursor-pointer hover:bg-[#333f53] ease-in-out duration-100 '>
